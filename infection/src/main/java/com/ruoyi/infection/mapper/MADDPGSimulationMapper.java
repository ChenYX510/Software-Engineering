...
public interface MADDPGSimulationMapper {
    // 获取最新的决策id
    //Integer getLatestPolicyId(@Param("userId") long userId);
    ...
    //int getSimulationFileIdByFilePath(@Param("userId") long userId, @Param("simulationFileName") String simulationFileName);
}
